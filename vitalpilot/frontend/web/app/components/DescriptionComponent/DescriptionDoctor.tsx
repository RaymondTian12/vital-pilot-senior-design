    ...
    <div className="flex h-[600]">
        <div className="relative basis-3/5">
          <Image
            ...
            width={1489}
            height={1056}
            className="absolute left-20 top-20  w-130 h-100 rounded-2xl shadow-[1px_1px_10px] shadow-black ml-15"
          />
          ...
          <Image src="/assets/doctor_description.png" alt='' width={1024} height={1536} className='absolute left-1 top-10 w-[400] -z-10'/>
        </div>
